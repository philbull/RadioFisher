...
for k in range(len(names)):
    ...
    px = baofisher.indexes_for_sampled_fns(4, zc.size, zfns) # x 4
    py = baofisher.indexes_for_sampled_fns(5, zc.size, zfns) # y 5
...
labels = ['Euclid ($\Omega_K, \gamma$ fixed)', 'SKA+MK ($\Omega_K, \gamma$ fixed)']
lines = []

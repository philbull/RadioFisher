...
Fboss, lbl_boss = baofisher.combined_fisher_matrix( F_list,
...
for k in _k:
    ...
    # Combine with BOSS
    F, lbls = baofisher.add_fisher_matrices(F, Fboss, lbls, lbl_boss, expand=True)
    ...
    print "FOM:", baofisher.figure_of_merit(pw0, pwa, Fpl, cov=cov_pl)

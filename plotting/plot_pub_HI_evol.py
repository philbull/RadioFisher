...
names = ['Linear', 'Bagla et al. (2010)', 'Dave et al. (2013)', 'Obreschkow et al. (2009)']
#colours = ['k', 'r', 'b', 'y']
colours = ['#1619A1', '#FFD200', '#CC0000', '#5B9C0A']
...
for i in range(len(fname)):
    ...
    ax1.plot(z, bias, color=colours[i], lw=2.5, label=names[i])
...
ax1.set_ylabel(r"$b_\mathrm{HI}(z)$", fontsize=20)

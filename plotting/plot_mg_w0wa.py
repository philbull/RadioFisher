...
if W0GAMMA:
    ...
    plabel2 = r"$\gamma$"
    y = 0.55
    fig_name = "mg-w0gamma-%d.pdf" % MGMODE
else:
    param2 = 'wa'
    plabel2 = r"$w_a$"
    y = 0.
    fig_name = "mg-w0wa-%d.pdf" % MGMODE
...
#names = ['BOSS_mg', 'aLOW_Alt_mgD', 'MID_B1_Alt_mgD', 'EuclidRef_mgD', 'MID_B2_Alt_mgD', 'gSKA2MG_mgD',]
##names = ['BOSS_mg', 'aLOW_Alt_mg', 'hMID_B1_Octave_mg', 'EuclidRef_mg', 'hMID_B2_Octave_mg', 'gSKA2MG_mg',]
##labels = ['BOSS', 'LOW (Alt.)', 'MID B1 + MK (Alt.)', r'H$\alpha$ survey', 'MID B2 + MK (Alt.)', 'SKA2', ]

...
P.xlabel('$z$', labelpad=10., fontdict={'fontsize':'x-large'})
P.ylabel('$\sigma(f \sigma_8) / (f \sigma_8)$', labelpad=15., fontdict={'fontsize':'x-large'})

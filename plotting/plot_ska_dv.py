...
#-------------------------------------------------------------------------------
filename = "ska-bao-dv-bigscale.pdf" #"ska-bao-dv.pdf"
names = [ 'fSKA1SUR650_baoonly_25000', 'SKA1MID900_baoonly_25000', 
          'gSKASURASKAP_baoonly', 'gSKA2_baoonly', # 'gSKAMIDMKB2_baoonly'
          'BOSS_baoonly', 'EuclidRef_baoonly', 'WFIRST_baoonly', 'SKA1MID350_baoonly_25000' ] #'iMFAA']
labels = ['SKA1-SUR B2 (IM)', 'SKA1-MID B2 (IM)', 
          'SKA1-MID/SUR (gal.)', 'SKA2 (gal.)', 
          'BOSS (gal.)', 'Euclid (gal.)', 'WFIRST (gal.)', '**SKA1-MID B1 (IM)']
colours = ['#8082FF', '#1619A1', '#FFB928', '#CC0000', # '#ff6600'
           '#4D4D4D', '#858585', '#c1c1c1', 'y']
linestyle = [[], [], [], [], [], [], [], [], []]
marker = ['D', 'D', 's', 's', 'o', 'o', 'o', 'o', 'o']
